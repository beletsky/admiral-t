 ...
 *
 * ѕреобразует строку из кодировки UTF-16 / UCS-2 в UTF-8.
 * —уррогаты UTF-16 поддерживаютс€!
 *
 * @param    string        $s
...
function utf16_to_utf8($s, $type = 'BE', $to_array = false)
{
    ...
    characters in planes 1Ц16, not just those in plane 0 (BMP). 
    ...
    of values are used for the two surrogates: 0xD800Ц0xDBFF for the first, most 
    ...
    in the U+D800ЦU+DFFF range, so an individual code value from a surrogate pair does not ever 
