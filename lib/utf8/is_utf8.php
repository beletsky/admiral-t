 ...
 * ƒл€ значений null, integer, float, boolean возвращает TRUE.
 *
 * ћассивы обход€тс€ рекурсивно, если в хот€бы одном элементе массива его значение
 * не в кодировке UTF-8, возвращаетс€ FALSE.
 *
 * @param    mixed(array/scalar/null)  $data
 * @param    bool                      $is_strict    строга€ проверка диапазона ASCII?
 * @return   bool
 *
