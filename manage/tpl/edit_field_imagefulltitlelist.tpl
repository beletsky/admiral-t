...
<!-- BEGIN image_add_item_ -->
            <tr>
                <td>{INDEX_1})</td>
                <td>Малое: <input type="file" name="{FIELD}[{INDEX}]"></td>
                <td>Большое: <input type="file" name="{FIELD}_Full[{INDEX}]"></td>
            </tr>
            <tr>
                <td></td>
                <td colspan="2">
                    Описание: 
                    <input type="text" name="{PREFIX}form[{FIELD}_Notes][{INDEX}]" value="" style="width: 450px;" />
                </td>
            </tr>
<!-- END image_add_item_ -->
        </table>
